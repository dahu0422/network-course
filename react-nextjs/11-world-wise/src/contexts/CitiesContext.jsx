import { useEffect, useState, createContext, useContext, useReducer, useCallback } from "react"
...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "cities/created": return { ...state, isLoading: false, cities: [...state.cities, action.payload], currentCity: action.payload }
    case "cities/deleted": return { ...state, isLoading: false, cities: state.cities.filter((city) => city.id !== action.payload), currentCity: {} }
